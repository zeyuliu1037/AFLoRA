...
ipt_all_tasks_config = {
    'mrpc': {**ipt_base_config, 
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 14, },
    'cola': {**ipt_base_config, 
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 14, },
    'stsb': {**ipt_base_config, 
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 14, },
    'sst2': {**ipt_base_config, 
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 7, },
    'rte': {**ipt_base_config,
                ...
                "initial_warmup": 1, 
                "final_warmup": 14, },
    'qnli': {**ipt_base_config,
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 7, },
    'mnli': {**ipt_base_config, 
                # "warmup_steps": 120,
                "initial_warmup": 1, 
                "final_warmup": 7, },
    'qqp': {**ipt_base_config, 
...
class Pruner(object):
    ...
    def schedule_threshold_comb(self, step: int):
        ...
        warmup_steps = total_step // self.config['num_train_epochs']
        mask_ind = False
